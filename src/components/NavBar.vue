<template>
  <div class="main-nav-bar">
    ...
    <div class="add-button" @click="handleAddButton">
      ...
      >
        <g clip-path="url(#clip0)">
          <path
            d="M14.3873 14.3874C9.0877 19.687 9.0877 28.2544 14.3873 33.554C19.6869 38.8536 28.2544 38.8536 33.5539 33.554C38.8535 28.2544 38.8535 19.687 33.5539 14.3874C28.2544 9.0878 19.6869 9.0878 14.3873 14.3874ZM32.2027 22.6195V25.322L25.3219 25.322V32.2028L22.6194 32.2028V25.322L15.7385 25.322V22.6195L22.6194 22.6195V15.7386L25.3219 15.7386V22.6195L32.2027 22.6195Z"
        ...
        <defs>
          ...
          <clipPath id="clip0">
            <rect
              ...
              height="32.5269"
              fill="white"
              transform="translate(0.970703 23.9707) rotate(-45)"
            />
          </clipPath>
        </defs>
      </svg>
    ...
    >
      ...
      >
        <path
          d="M9 3V4H4C2.90694 4 2 4.90694 2 6V10V14V18C2 19.0931 2.90694 20 4 20H20C21.0931 20 22 19.0931 22 18V14V10V6C22 4.90694 21.0931 4 20 4H15V3H9ZM4 6H20V10V14H4V10V6ZM12 10C11.7348 10 11.4804 10.1054 11.2929 10.2929C11.1054 10.4804 11 10.7348 11 11C11 11.2652 11.1054 11.5196 11.2929 11.7071C11.4804 11.8946 11.7348 12 12 12C12.2652 12 12.5196 11.8946 12.7071 11.7071C12.8946 11.5196 13 11.2652 13 11C13 10.7348 12.8946 10.4804 12.7071 10.2929C12.5196 10.1054 12.2652 10 12 10ZM4 16H20V18H4V16Z"
          fill="#A6A5AA"
        />
      </svg>
    </div>
